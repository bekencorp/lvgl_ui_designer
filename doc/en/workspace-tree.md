...
**Adjust Order at Same Level**
1. Select component
2. Drag to target position
3. Release mouse to complete reordering

**Parent-Child Relationship**
1. Drag component onto target parent component

**Note**:
- Only container type components can be parent components
